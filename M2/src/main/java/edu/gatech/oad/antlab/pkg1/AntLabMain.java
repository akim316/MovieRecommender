 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Michelle Chiu");
		  toPrint += p1.toString("mchiu6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Amy Liu");
		  toPrint += p2.toString("aliu66");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Andy Chung");
		  toPrint += p3.toString("achung6");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Alex Kim");
                  toPrint += p4.toString("akim316");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Sana Ajani");
          toPrint += p5.toString("sajani6");
